 ...
 */
/* 빌드 버전 — 화면 슬라이스가 끝날 때마다 RC를 올립니다.
 * 이슈의 「영향 받는 버전」이 이 값을 가리키므로, 테스터가 어느 빌드에서 재현했는지
 * 화면(푸터)에서 바로 확인할 수 있어야 합니다.
 *   RC1 = 전역 셸 · S1 · 라우팅 가드 · P4 간편 프로필 · T1 디버그 콘솔
 */
const SUT_BUILD = "PC웹_Ver1.0_RC1";
