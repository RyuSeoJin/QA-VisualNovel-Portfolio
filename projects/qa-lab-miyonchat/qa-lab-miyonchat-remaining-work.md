...
| 다음 착수 지점 | **§백로그에서 고릅니다.** 결정 대기는 비었고, 백로그 셋은 전부 조건 대기입니다 — 두 번째 프로젝트 착수 시 / 리그레션 TC 세트와 함께 / 결함이 쌓인 뒤 |
