...
change-log가 담당합니다. 갱신일: 2026-08-03 (결정 대기 전부 해소 · 골격 v1.10 · SUT RC21 완료 · TC 본문 착수 직전).
...
| 다음 착수 지점 | **TC 본문 작성 — 첫 영역 「웹 진입」.** 설계 규칙은 전부 확정됐고 `tcs` 배열만 비어 있습니다. RC21로 명세와 화면이 맞았으므로 「탐색」 영역도 막히지 않습니다 |
