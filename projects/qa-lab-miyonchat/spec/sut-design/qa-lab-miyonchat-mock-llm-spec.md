...
| 세트 | 대상 | 쓰임 |
|---|---|---|
| **전용 세트** | 하루(c1)의 시나리오별 | 시나리오 시작점 차이·서사 진행·엔딩 도달을 보는 기준 캐릭터. TC의 기본 경로는 여기를 씁니다 |
| **공통 세트** | 그 외 전 캐릭터 + T1에서 생성한 캐릭터 | 캐릭터 이름·호칭만 치환되는 중립 대사. 방 격리·계정 격리·재화·되돌림처럼 **대사 내용과 무관한 규칙**은 이 세트로 검증합니다 |
